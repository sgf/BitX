...
namespace BitXGenerator
{
    ...
    public class BitNAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static DiagnosticDescriptor Rule = new DiagnosticDescriptor(DiagnosticId, "BitNAnalyzerTitle", "BitNAnalyzerMessageFormat", Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: "BitNAnalyzerDescription");
